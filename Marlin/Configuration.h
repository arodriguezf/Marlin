...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 218.0 //215.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 329.52//250.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 96.54//105.2 //mm  Get this value from auto calibrate
  
  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.0, 0.0, 0.0 } // get these values from auto calibrate //  { -1.29, -0.86, 0.00 }
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 96 } //{ 80, 80, 80, 760*1.1 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 200 } //{ 500, 500, 500, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {3000,3000,3000,3000 } //{ 9000, 9000, 9000, 10000 }
 ...
 */
#define DEFAULT_ACCELERATION          2000 //3000    // X, Y, Z and E acceleration for printing moves
 ...
 */
#define DEFAULT_XJERK                 5.0 //20.0
#define DEFAULT_YJERK                 5.0 //20.0
#define DEFAULT_ZJERK                 5.0 //20.0 // Must be same as XY for delta
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -16.73 //-3.5  // Z offset: -below +above  [the nozzle]
...
#define INVERT_X_DIR true //false // DELTA does not invert
